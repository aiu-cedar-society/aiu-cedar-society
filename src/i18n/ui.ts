/**
 * UI Translations - Static text translations for the website
 * 
 * Add all static UI text here. Dynamic content from MicroCMS
 * should have _en fields added in the CMS.
 */
